...
if __name__ == '__main__':
    ...
    mesh_path = r'F:\biyesheji\MeshSNet\dentalmesh(1)\aug_stl_10w'  # need to define
    sample_filenames = ['A1_Sample_01.stl'] # need to define
    output_path = './outputs'
    ...
    with torch.no_grad():
        for i_sample in sample_filenames:
            ...
            scio.savemat(r'F:\biyesheji\MeshSNet\dentalmesh(1)\stl_to_mat_10w\A1_Sample_01_step5_predict.mat', {'step5': X})
            ...
            vedo.write(mesh2, os.path.join(output_path, '{}_d_predicted_test.vtp'.format(i_sample[:-4])))
