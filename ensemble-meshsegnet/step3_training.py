...
if __name__ == '__main__':
    ...
    train_list = 'F:\\biyesheji\MeshSNet\dentalmesh(1)\dentalmesh\stl_save_h5\\' # use 1-fold as example
    val_list = 'F:\\biyesheji\MeshSNet\dentalmesh(1)\dentalmesh\stl_save_h5\\' # use 1-fold as example

    model_path = './models/'
    model_name = 'Mesh_Segementation_MeshSegNet_test1' # need to define
